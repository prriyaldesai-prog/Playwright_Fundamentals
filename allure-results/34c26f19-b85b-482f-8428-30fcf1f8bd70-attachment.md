...
Call log:
  - waiting for getByRole('textbox', { name: 'email' })
    - locator resolved to <input required="" type="email" name="email" id="page-v1-step1-email" data-qa="page-su-step1-v1-email" placeholder="name@yourcompany.com" class="W(100%) Py(14px) input-text"/>
  - elementHandle.type("prriyaldesai@gmail.com")
