...
```ts
  ...
  28 | 
  29 |     let registrationResult = page.locator("#vehicle-output");
  30 | 
> 31 |     await expect(registrationResult).toHaveText(`{
     |                                      ^ Error: expect(locator).toHaveText(expected) failed
  32 |     "vehicleName": "Honda City",
  33 |     "ownerName": "PriyalDesai",
  34 |     "regNumber": "GJ-18-GJ-12345",
  35 |     "vehicleType": "Sedan",
  36 |     "year": "2026",
  37 |     "notes": "Honda City is a sunroof car and very nice to drive in city and highway"
  38 | }`);
  39 | 
  40 | });
```