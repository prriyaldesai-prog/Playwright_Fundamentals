...
Call log:
  - waiting for locator('#RESULT_TextField-1').contentFrame().getByText('Vehicle name')
    ...
    - banner [ref=e208]:
      ...
      - generic [ref=e217]:
        - generic [ref=e218] [cursor=pointer]:
          - checkbox "Locator markers" [active] [ref=e219]
        ...
        - generic [ref=e241]:
          - article [ref=e242]:
            ...
            - paragraph [ref=e251]:
              ...
              - strong [ref=e252]: iframe[id*='frame-one']
              - text: ·
              - strong [ref=e253]: iframe[name='vehicle-form']
              - text: ·
              - strong [ref=e254]: iframe[title*='Vehicle']
          - article [ref=e255]:
            - heading "② Multi-frame frameset — named frames" [level=2] [ref=e256]
            - paragraph [ref=e257]:
              ...
              - code [ref=e260]: side
              - text: ","
              - code [ref=e261]: footer
              - text: ). Open it in a new tab to use
              - code [ref=e262]: page.locator('//frame').all()
              - text: and count
              - code [ref=e263]: page.frames()
              - text: .
            - link "Open multi-frames frameset 3 frames named main / side / footer · best opened in a new tab" [ref=e264] [cursor=pointer]:
              - /url: ./multi-frames.html
              - img [ref=e266]
              - generic [ref=e268]:
                - strong [ref=e269]: Open multi-frames frameset
                - generic [ref=e270]: 3 frames named main / side / footer · best opened in a new tab
        - complementary [ref=e271]:
          - generic [ref=e272]:
            - heading "What students should practise" [level=3] [ref=e273]
            - list [ref=e274]:
              - listitem [ref=e275]:
                - text: Reach
                - code [ref=e276]: "#RESULT_TextField-1"
                - text: via
                - code [ref=e277]: page.frameLocator("iframe[id*='frame-one']")
                - text: and fill it.
              - listitem [ref=e278]:
                - text: Read the outer-page heading
                - code [ref=e279]: h3.details__form-preview-title
                - text: and assert the page title.
              - listitem [ref=e280]:
                - text: On the frameset page, use
                - code [ref=e281]: frameLocator("[name='main']")
                - text: and read its h2.
              - listitem [ref=e282]:
                - text: Count frames via
                - code [ref=e283]: page.locator('//frame').all()
                - text: and
                - code [ref=e284]: page.frames().length
                - text: .
              - listitem [ref=e285]: Iterate frames and log each frame's name and src.
          - group [ref=e286]:
            - generic "Playwright solution Both scenarios — iframe form fill and frameset enumeration. Show solution" [ref=e287] [cursor=pointer]:
              - img [ref=e289]
              - generic [ref=e291]:
                - strong [ref=e292]: Playwright solution
                - generic [ref=e293]: Both scenarios — iframe form fill and frameset enumeration.
              - generic [ref=e294]: Show solution
```
...
```ts
  ...
  6 |     let mainframe = await page.frameLocator("#RESULT_TextField-1");
> 7 |     await mainframe.getByText("Vehicle name").fill("Honda City");
    |                                               ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  8 | 
  9 | });
```