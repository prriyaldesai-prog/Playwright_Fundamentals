...
```
Error: locator.click: SyntaxError: Failed to execute 'querySelectorAll' on 'Element': 'td:data' is not a valid selector.
...
Call log:
  - waiting for locator('tr:has(td:data)').locator('td').first()
